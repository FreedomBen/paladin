//! AES Crypt (`.aes`) read-interop tests for the `symcrypt` binary (PLAN_05 §6).
//!
//! These run against a genuine AES Crypt Stream Format 2 fixture minted by
//! `aescrypt 3.16.1` (committed under `symcrypt-core/tests/data/aescrypt/`), so
...
const V2_FIXTURE: &[u8] = include_bytes!("../../symcrypt-core/tests/data/aescrypt/v2_size_17.aes");
