//! `paladin-tui` — interactive terminal front-end for paladin.
//!
//! A thin view over `paladin-core` (crypto/format) and `paladin-common`
...
#[command(
    name = "paladin-tui",
    version,
    about = "Interactive terminal front-end for paladin"
)]
struct Args {
