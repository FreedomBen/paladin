//! Map `paladin_core::SymError` to user-facing toast/dialog text.
//!
...
pub fn user_message(err: &SymError) -> String {
    match err {
        ...
        SymError::BadMagic => "This is not a recognized paladin or AES Crypt file.".to_string(),
        SymError::UnsupportedVersion(v) => format!("Unsupported paladin file version ({v:#04x})."),
